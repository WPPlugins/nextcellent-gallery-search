...
= NextCellent Gallery - Search Galleries =
...
NextCellent Gallery - Search Galleries even adds an option to search in the description which can be helpful if you don’t remember the name.

And NextCellent Gallery - Search Galleries also has the ability to search for a part of the name or description. 
...
1. Download NextCellent Gallery - Search Galleries to your computer
2. Log into your WordPress admin
3. Click **Plugins --> Add New**
4. Click **Upload** (in the header)
5. Search your computer for **nextcellent-gallery-search-galleries-XX.zip**
6. Click **Install Now**
...
1. NextCellent Gallery - Search Galleries page.